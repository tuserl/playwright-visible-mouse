...
const fs = require('fs');
const { computeWindowArgs } = require("./windowTiling");
...
class BrowserManager {
  ...
  async launch(options = {}) {
    ...
    const { args: tileArgs, resolvedTileIndex } = computeWindowArgs({
      mode, tileIndex: currentTileIndex, screenWidth, screenHeight
    });
    args.push(...tileArgs);
